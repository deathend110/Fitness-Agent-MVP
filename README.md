...
- 维护用户档案、训练目标和三大项 1RM
- 我的档案页提供浅色渐变头图、结构化摘要卡、分组表单和折叠式数据管理区，适合日常记录与演示展示
...
- 自定义力量周期计划支持手动填写主项 TM 快照、开始日期、周数，以及按周维护基础 day type 结构
...
7. 进入“AI 教练”发送问题，观察流式回复和上下文驱动的建议
8. 如果出现计划建议卡，点击确认写回
9. 返回“训练计划”确认对应日程已经更新；周期模式下可继续手动生成或确认下一周
